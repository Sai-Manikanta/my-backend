...
const { signup, verifyUser, approveUser, loginUser, verifySandboxAccess, getMyDetails, resetPassword, forgotPassword, generatePassword } = require('../controllers/user.js');
